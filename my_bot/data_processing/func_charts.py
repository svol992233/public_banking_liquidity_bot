...
# параметры запроса тут мы берем данные из html шаблона в разделе кнопки с датой
...
"""______________________________________________________ГРАФИКИ_____________________________________________________"""
